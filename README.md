...
Given a protocol PDF, extract all tables into structured JSON that conforms to `schema/protocol\_table.schema.json`.
...
\- `inputs/examples/file\_parser\_example.json`
...
&#x20;  - `schema/protocol\_table.schema.json`

&#x20;  - `benchmarks/BENCHMARK\_PLAN.md`

&#x20;  - `prompts/CODEX\_BOOTSTRAP\_PROMPT.md`
...
\- `python -m src.eval.validate\_outputs`

\- `python -m src.eval.run\_benchmark`

\- `python -m src.runner.report\_metrics`
